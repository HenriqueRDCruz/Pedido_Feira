    ...
    div.innerHTML
        = `
                <div class="form-group">
                    ...
                    <input classeform-control" type="hidden" name="linhaPedido${index}" value="----------------------------------------------">
                    </div>
                </div>
                ...
                <div class="input-group mb-3">
                        ...
                        <input  type="double" class="form-control" id="${inputQuantidadeId}" name="quantidade_${index}" placeholder="INSIRA A QUANTIDADE" 
                ...
                <div class="input-group mb-3">
                        ...
                        <input  type="double" class="form-control" id="${inputValorProdutoId}" name="valor_produto_${index}" placeholder="INSIRA O VALOR DO PRODUTO" 
                                oninput="this.value = this.value.replace(/[^0-9.,]/g, '');"
                                required>
